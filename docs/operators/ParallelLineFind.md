...
|--------|------|--------|------|------|
| `AngleTolerance` | `double` | `5.0` | [0.0, 45.0] | 角度参数。 |
| `MinLength` | `double` | `40.0` | [1.0, 100000.0] | 最小数量或下限约束。 |
| `MinDistance` | `double` | `2.0` | [0.0, 100000.0] | 最小数量或下限约束。 |
| `MaxDistance` | `double` | `200.0` | [0.0, 100000.0] | 最大数量或上限约束。 |
...
| `Line1` | Line 1 | `LineData` | 输出线几何结果。 |
| `Line2` | Line 2 | `LineData` | 输出线几何结果。 |
| `Distance` | Distance | `Float` | 输出本算子的处理结果。 |
...
| `parallel` | `Auto` | 当前实现中的运行时附加字段，具体语义以源码输出逻辑为准。 |
| `Line1` | `Auto` | 当前实现中的运行时附加字段，具体语义以源码输出逻辑为准。 |
| `Line2` | `Auto` | 当前实现中的运行时附加字段，具体语义以源码输出逻辑为准。 |
