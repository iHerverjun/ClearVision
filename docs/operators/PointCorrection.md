...
|--------|------|--------|------|------|
| `CorrectionMode` | `enum` | TranslationOnly | - | - |
...
|------|------|------|------|------|
| `DetectedPoint` | Detected Point | `Point` | Yes | - |
| `DetectedAngle` | Detected Angle | `Float` | No | - |
| `ReferencePoint` | Reference Point | `Point` | Yes | - |
| `ReferenceAngle` | Reference Angle | `Float` | No | - |

### 输出 / Outputs
| 名称 (Name) | 显示名 (DisplayName) | 数据类型 (DataType) | 说明 (Description) |
|------|------|------|------|
| `CorrectionX` | Correction X | `Float` | - |
| `CorrectionY` | Correction Y | `Float` | - |
| `CorrectionAngle` | Correction Angle | `Float` | - |
