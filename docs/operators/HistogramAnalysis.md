...
> 中文：Computes histogram and distribution statistics for selected channel.。
> English: Computes histogram and distribution statistics for selected channel..
...
| `StdDev` | StdDev | `Float` | - |
| `Mode` | Mode | `Integer` | - |
| `Median` | Median | `Integer` | - |
| `Peak` | Peak | `Integer` | - |
| `Valley` | Valley | `Integer` | - |
