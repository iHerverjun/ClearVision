...
> 生成时间 / Generated At: `2026-03-03 20:34:27 +08:00`
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.AkazeFeatureMatch` | AKAZE特征匹配 | 2 | 4 | 5 | 63 (C) | `1.0.0` | - | [AkazeFeatureMatch](./AkazeFeatureMatch.md) |
| `OperatorType.GradientShapeMatch` | 梯度形状匹配 | 2 | 5 | 5 | 73 (B) | `1.0.0` | - | [GradientShapeMatch](./GradientShapeMatch.md) |
| `OperatorType.OrbFeatureMatch` | ORB特征匹配 | 2 | 4 | 5 | 63 (C) | `1.0.0` | - | [OrbFeatureMatch](./OrbFeatureMatch.md) |
| `OperatorType.PyramidShapeMatch` | 金字塔形状匹配 | 2 | 5 | 5 | 73 (B) | `1.0.0` | - | [PyramidShapeMatch](./PyramidShapeMatch.md) |
| `OperatorType.ShapeMatching` | Shape Matching | 2 | 2 | 7 | 90 (A) | `1.0.0` | - | [ShapeMatching](./ShapeMatching.md) |
| `OperatorType.TemplateMatching` | 模板匹配 | 2 | 4 | 3 | 86 (A) | `1.0.0` | - | [TemplateMatching](./TemplateMatching.md) |
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.Aggregator` | 数据聚合 | 3 | 4 | 1 | 51 (D) | `1.0.0` | - | [Aggregator](./Aggregator.md) |
| `OperatorType.ArrayIndexer` | 数组索引器 | 1 | 1 | 2 | 69 (C) | `1.0.0` | - | [ArrayIndexer](./ArrayIndexer.md) |
| `OperatorType.BoxFilter` | 候选框过滤 (Bounding Box) | 2 | 3 | 9 | 80 (B) | `1.0.0` | - | [BoxFilter](./BoxFilter.md) |
| `OperatorType.BoxNms` | 候选框抑制 | 2 | 3 | 3 | 80 (B) | `1.0.0` | - | [BoxNms](./BoxNms.md) |
...
| `OperatorType.CaliperTool` | 卡尺工具 | 2 | 4 | 6 | 84 (B) | `1.0.0` | - | [CaliperTool](./CaliperTool.md) |
| `OperatorType.CircleMeasurement` | 圆测量 | 1 | 5 | 7 | 90 (A) | `1.0.0` | - | [CircleMeasurement](./CircleMeasurement.md) |
...
| `OperatorType.GeometricFitting` | Geometric Fitting | 1 | 2 | 7 | 90 (A) | `1.0.0` | - | [GeometricFitting](./GeometricFitting.md) |
...
| `OperatorType.WidthMeasurement` | 宽度测量 | 3 | 4 | 3 | 86 (A) | `1.0.0` | - | [WidthMeasurement](./WidthMeasurement.md) |
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.BlobAnalysis` | Blob分析 | 1 | 3 | 3 | 84 (B) | `1.0.0` | - | [BlobAnalysis](./BlobAnalysis.md) |
| `OperatorType.ContourDetection` | 轮廓检测 | 1 | 3 | 5 | 84 (B) | `1.0.0` | - | [ContourDetection](./ContourDetection.md) |
| `OperatorType.EdgeDetection` | Edge Detection | 1 | 2 | 7 | 66 (C) | `1.0.0` | - | [EdgeDetection](./EdgeDetection.md) |
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.CodeRecognition` | 条码识别 | 1 | 4 | 2 | 84 (B) | `1.0.0` | - | [CodeRecognition](./CodeRecognition.md) |
...
| `OperatorType.ResultOutput` | 结果输出 | 4 | 1 | 2 | 69 (C) | `1.0.0` | - | [ResultOutput](./ResultOutput.md) |

### 通信 (8)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.HttpRequest` | HTTP 请求 | 1 | 3 | 4 | 73 (B) | `1.0.0` | - | [HttpRequest](./HttpRequest.md) |
...
| `OperatorType.MqttPublish` | MQTT 发布 | 1 | 1 | 4 | 73 (B) | `1.0.0` | - | [MqttPublish](./MqttPublish.md) |
...
| `OperatorType.TypeConvert` | Type Convert | 1 | 1 | 2 | 73 (B) | `1.0.0` | - | [TypeConvert](./TypeConvert.md) |
...
| `OperatorType.TriggerModule` | 触发模块 | 0 | 3 | 3 | 74 (B) | `1.0.0` | - | [TriggerModule](./TriggerModule.md) |

### 采集 (1)
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.ImageAcquisition` | 图像采集 | 0 | 1 | 3 | 68 (C) | `1.0.0` | - | [ImageAcquisition](./ImageAcquisition.md) |
...
| `OperatorType.ClaheEnhancement` | CLAHE增强 | 1 | 1 | 4 | 66 (C) | `1.0.0` | - | [ClaheEnhancement](./ClaheEnhancement.md) |
| `OperatorType.ColorConversion` | 颜色空间转换 | 1 | 1 | 1 | 84 (B) | `1.0.0` | - | [ColorConversion](./ColorConversion.md) |
...
| `OperatorType.HistogramEqualization` | 直方图均衡化 | 1 | 1 | 3 | 84 (B) | `1.0.0` | - | [HistogramEqualization](./HistogramEqualization.md) |
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.ColorDetection` | 颜色检测 | 1 | 2 | 9 | 66 (C) | `1.0.0` | - | [ColorDetection](./ColorDetection.md) |
| `OperatorType.ColorMeasurement` | 颜色测量 | 2 | 8 | 8 | 84 (B) | `1.0.0` | - | [ColorMeasurement](./ColorMeasurement.md) |
