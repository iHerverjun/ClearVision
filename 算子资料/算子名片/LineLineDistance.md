...
|--------|------|--------|------|------|
| `ParallelThreshold` | `double` | `2.0` | [0.0, 45.0] | 用于判定、分割或筛选的阈值。 |

## 输入/输出端口 / Input/Output Ports
### 输入 / Inputs
| 名称 (Name) | 显示名 (DisplayName) | 数据类型 (DataType) | 必填 (Required) | 说明 (Description) |
|------|------|------|------|------|
| `Line1` | Line 1 | `LineData` | Yes | 提供线几何输入。 |
| `Line2` | Line 2 | `LineData` | Yes | 提供线几何输入。 |
...
| `Intersection` | Intersection | `Point` | 输出点位结果。 |
| `HasIntersection` | Has Intersection | `Boolean` | 输出本算子的处理结果。 |
| `IsParallel` | Is Parallel | `Boolean` | 输出本算子的处理结果。 |
## 性能特征 / Performance
| 指标 (Metric) | 值 (Value) |
|------|------|
