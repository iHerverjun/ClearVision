...
|--------|------|--------|------|------|
| `Angle` | `double` | `0.0` | [-360.0, 360.0] | 角度参数。 |
| `CenterX` | `int` | `-1` | - | 控制“CenterX”这一实现参数，建议结合现场样本调节。 |
| `CenterY` | `int` | `-1` | - | 控制“CenterY”这一实现参数，建议结合现场样本调节。 |
| `Scale` | `double` | `1.0` | [0.1, 10.0] | 缩放或比例参数。 |
| `AutoResize` | `bool` | `true` | - | 控制“AutoResize”这一实现参数，建议结合现场样本调节。 |
