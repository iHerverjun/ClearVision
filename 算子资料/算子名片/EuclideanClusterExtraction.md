...
> 中文：Euclidean Cluster Extraction for point clouds (3D connected components by distance).。
> English: Euclidean Cluster Extraction for point clouds (3D connected components by distance)..
...
|--------|------|--------|------|------|
| `ClusterTolerance` | `double` | 0.02 | >= 1E-06 | - |
| `MinClusterSize` | `int` | 100 | [1, 10000000] | - |
| `MaxClusterSize` | `int` | 1000000 | [1, 10000000] | - |
