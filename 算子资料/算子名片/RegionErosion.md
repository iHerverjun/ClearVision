...
> 中文：Erodes a region using a specified structuring element (Region-based morphology).。
> English: Erodes a region using a specified structuring element (Region-based morphology)..
...
|------|------|------|------|
| `Region` | Eroded Region | `Any` | - |
| `Image` | Visualization | `Image` | - |
| `Area` | Eroded Area | `Integer` | - |
