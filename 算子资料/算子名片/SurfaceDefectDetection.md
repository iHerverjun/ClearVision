...
> 中文：Detects surface defects using gradient, reference diff, or local contrast.。
> English: Detects surface defects using gradient, reference diff, or local contrast..
