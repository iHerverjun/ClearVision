...
> 中文：Runs non-maximum suppression on detection boxes.。
> English: Runs non-maximum suppression on detection boxes..
...
| `Image` | Image | `Image` | - |
| `Count` | Count | `Integer` | - |
| `InputCount` | Input Count | `Integer` | - |
| `SuppressedCount` | Suppressed Count | `Integer` | - |
| `SuppressedDetections` | Suppressed Detections | `DetectionList` | - |
