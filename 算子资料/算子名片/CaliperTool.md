...
> 中文：Detects edge pairs along a scan line and reports width.。
> English: Detects edge pairs along a scan line and reports width..
...
| `MeasureMode` | `enum` | edge_pairs | - | - |
| `PairDirection` | `enum` | any | - | - |
| `SubpixelAccuracy` | `bool` | false | - | - |
| `SubPixelMode` | `enum` | gradient_centroid | - | - |
...
| `PairDistances` | Pair Distances | `Any` | - |
| `AverageDistance` | Average Distance | `Float` | - |
| `DistanceStdDev` | Distance StdDev | `Float` | - |
