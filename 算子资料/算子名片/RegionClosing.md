...
> 中文：Closing operation (dilation followed by erosion) for filling small holes and connecting nearby regions.。
> English: Closing operation (dilation followed by erosion) for filling small holes and connecting nearby regions..
...
|------|------|------|------|
| `Region` | Closed Region | `Any` | - |
| `Image` | Visualization | `Image` | - |
| `Area` | Closed Area | `Integer` | - |
