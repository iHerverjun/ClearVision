...
> 中文：Compute Point Pair Features (PPF) for a point cloud and build a per-point feature map.。
> English: Compute Point Pair Features (PPF) for a point cloud and build a per-point feature map..
...
| `FeatureRadius` | `double` | 0.05 | >= 1E-06 | - |
| `UseExistingNormals` | `bool` | true | - | - |
