# Subpixel Edge Detection / SubpixelEdgeDetection
...
> 中文：Extracts subpixel edges using Steger or interpolation-based methods.。
> English: Extracts subpixel edges using Steger or interpolation-based methods..
...
| `EdgeThreshold` | `double` | 10 | [0, 1000] | - |
