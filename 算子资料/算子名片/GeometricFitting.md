...
> 中文：Fits line, circle or ellipse from contour points.。
> English: Fits line, circle or ellipse from contour points..
...
| `MinArea` | `int` | 100 | >= 0 | - |
| `MinPoints` | `int` | 5 | [3, 10000] | - |
| `ContourSelection` | `enum` | LargestContour | - | - |
| `RobustMethod` | `enum` | LeastSquares | - | - |
| `RansacIterations` | `int` | 200 | [10, 5000] | - |
| `RansacInlierThreshold` | `double` | 2 | [0.1, 100] | - |
