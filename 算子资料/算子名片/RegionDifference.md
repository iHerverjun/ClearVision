...
> 中文：Computes the difference of two regions (A - B).。
...
|------|------|------|------|------|
| `Region1` | First Region (Minuend) | `Any` | Yes | - |
| `Region2` | Second Region (Subtrahend) | `Any` | Yes | - |

### 输出 / Outputs
| 名称 (Name) | 显示名 (DisplayName) | 数据类型 (DataType) | 说明 (Description) |
|------|------|------|------|
| `Region` | Difference Region | `Any` | - |
| `Image` | Visualization | `Image` | - |
| `Area` | Difference Area | `Integer` | - |
