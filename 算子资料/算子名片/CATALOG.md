...
> 生成时间 / Generated At: `2026-03-21 12:03:10 +08:00`
...
| 枚举 (Enum) | 显示名 (DisplayName) | 输入 | 输出 | 参数 | 质量 (Q) | 版本 (Version) | 算法 (Algorithm) | 文档 |
|------|------|------:|------:|------:|------|------|------|------|
| `OperatorType.DetectionSequenceJudge` | Detection Sequence Judge | 1 | 7 | 7 | 80 (B) | `1.0.0` | - | [DetectionSequenceJudge](./DetectionSequenceJudge.md) |
